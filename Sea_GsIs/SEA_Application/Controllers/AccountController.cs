        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            try
            {
                if (userID != null)
                {
                    ...
                    else if (UserManager.IsInRole(userID, "Super_Admin"))
                    {
                    ...
                    else if (UserManager.IsInRole(userID, "Branch_Admin"))
                    {
                        System.Web.HttpContext.Current.Session["BranchAdminID"] = userID;
                        return RedirectToAction("Index", "BranchAdmin");
                    }
                    else if (UserManager.IsInRole(userID, "Branch_Principal"))
                    {
                        System.Web.HttpContext.Current.Session["BranchPrincipalID"] = userID;
                        return RedirectToAction("Index", "BranchAdmin");
                    }
                    else
                    {
            ...
            try
            {
                ...
                switch (result)
                {
                    case SignInStatus.Success:
                        ...
                        {
                            System.Web.HttpContext.Current.Session["Super_Admin"] = userID;
                            return RedirectToAction("index", "SuperAdmin");
                        }
                        else if (UserManager.IsInRole(userID, "Accountant"))
                        {
                        ...
                        //else if (UserManager.IsInRole(userID, "Branch_Principal"))
                        //{
                        //    return RedirectToAction("Index", "BranchPrincipal");
                        //}
