...
namespace SEA_Application.Controllers
{
    public class EmployeeAdvanceSalariesController : Controller
    {
        ...
        {
            var employeeAdvanceSalaries = db.EmployeeAdvanceSalaries.Include(e => e.AspNetSession).Include(e => e.AspNetEmployee);
        ...
        public ActionResult Create([Bind(Include = "Id,EmployeeId,AdvanceSalary,Months,Date,Status,SessionId")] EmployeeAdvanceSalary employeeAdvanceSalary)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    Ledger ledger = db.Ledgers.Where(x => x.Name == "Employee Clearing").FirstOrDefault();////Expence
                    ledger.StartingBalance += employeeAdvanceSalary.AdvanceSalary;
                    ledger.CurrentBalance += employeeAdvanceSalary.AdvanceSalary;
                    db.SaveChanges();
